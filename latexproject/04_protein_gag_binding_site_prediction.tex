...
% What makes this prediction less certain than e.g.\ in case of SDF-1
%and FGF2 is the fact that the characteristic isovalue of the Coulomb potential
%in the predicted regions is significantly smaller than in named reference
%systems.
