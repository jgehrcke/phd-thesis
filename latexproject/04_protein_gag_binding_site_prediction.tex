...
hyaluronan heptasaccharide ligand as determined experimentally is shown in stick
representation with carbon atoms in orange (structure taken from PDB ID 2JCQ).}
\label{fig:bspred:sdf1_estatic}
\end{figure}
...
the receptor and the binding site location.
