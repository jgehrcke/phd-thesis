...
protein-GAG binding region prediction. Here, we see a clear conceptual advantage
...
prediction for any given system falsifies this docking approach as a whole,
whereas this docking method is backed by a conjunction of many statements
...
model was insufficient to describe the system. In \cite{salek_ardakani_2000},
where IL-10 was shown to bind heparin, the authors note that IL-10 residues 105
to 110 (LRRCHR) match the pattern XBBXBX, which was published as one of various
protein-GAG binding site \enquote{consensus sequence} earlier by various authors
\cite{mccaffrey_1992,cardin_weintraub_1989,fromm_1997,caldwell_1996,%
hileman_1998}.




The sequence 2-(), which is
conserved between all species of IL-10 sequenced to date, is
similar to one consensus site, XBBXBX
