...
AmberTools' PBSA program \cite{case_amber_12}

(choosing the modified ICCG solver
applied to the linearized Poisson-Boltzmann equation). The receptor atoms were
parameterized according to the FF99SB force field. The grid spacing was set to
$1\,\angstrom$. Isosurface visualization of the potential was done in VMD
\cite{vmd1996}.
