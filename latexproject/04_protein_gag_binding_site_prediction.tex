...
attraction for GAGs via Coulomb interaction is in a different league than FGF2's
and SDF-1's -- in the sense that it is much weaker. Comparison of the
...
\SI{2.0}{\kilo\calory\per\mole\per\elementarycharge} still represents a \textit{significant} attraction, with an energy per test charge that is about three
times larger than the thermal energy at room temperature.
