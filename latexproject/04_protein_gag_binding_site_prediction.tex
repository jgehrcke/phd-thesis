...
electrostatic potential of FGF-2 with an isosurface representation for varying
positive isovalues, i.e.\ for potential values that represent
\textit{attraction} for GAGs.
