...
NMR assignments of longer oligosaccharides are complicated or sometimes
impossible to obtain due to their repetitive nature. Furthermore, chemical
synthesis of oligosaccharides is very difficult. In short, the systematic
experimental investigation of protein-GAG systems is highly challenging and
resource-intensive. In the past, important advances have been made in the field
of the \textit{computational} investigation of these systems, with pioneering
work performed especially by the groups of Mancera and Imberty
...
protein-GAG investigation are still in their infancy, a major component of this
thesis project was the development and improvement of methodological approaches
whenever appropriate. From the beginning of the project onwards, it was the plan
to at some point integrate \textit{in silico}-based observations with
experimental results from collaborators at Prof. Huster's laboratory. The
general aim was to be able to provide insights into the molecular mechanisms
...
Specifically, one of the first challenging questions to be answered in this
project was where GAGs could potentially bind to the IL-10 surface. Based on
...
specificity of IL-10 for certain GAG types. The ultimate goal of this project
was to clarify atomic details of IL-10-GAG interaction and their possible
implications for IL-10's biological function. Based on such rationals, a
resulting vision could be the gain of control over IL-10 function within
artificial extracellular matrices, for instance for improved tissue
regeneration.
...
IL-2 happens, but does not interfere with IL-2/IL-2R interaction
...
molecular mechanisms, and principally serve as a template for what can and
should be found out about the IL-10-GAG system.