...
for the free (without IL-10 in solution) and bound (with IL-10 in solution) case
and discuss the implications of the corresponding results. This work is part of
our collaborative publication titled \enquote{NMR characterization of the
binding properties and conformation of glycosaminoglycans interacting with
interleukin-10} in the journal \textit{Glycobiology} \cite{kuenze_gehrcke_2014}.
