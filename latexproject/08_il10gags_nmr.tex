...
same solution, and once without presence of IL-10. The NMR protocol details of
these experiments have been published in \cite{kuenze_gehrcke_2014}. The
motivation of these experiments was to use the geometry information encoded in
the obtained NOESY data for creating two HP dp4 structure models, one for what
we call the \enquote{bound} state, and one for the \enquote{unbound} state (with
...
structure fulfilling the experimentally obtained distance constraints as good as
possible. I have approached this optimization problem with simulated annealing
