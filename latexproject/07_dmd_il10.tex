...
residues. Notably, R107 is conserved among species, as already discussed in
\cref{background:il10biologyprimer} and \cref{bspred:il10}.
...
Up to here, various observations have been made, which independently suggest
...
Another insight is that for HP as well as for HA, both analyzed as dp4 and dp6
...
residue, R107, significantly stands out compared to other residues and
...
specificity of IL-10 for a certain sulfation pattern, it remained undetectable
with the kind of data acquisition and analysis performed here: different GAG
types yielded data from a continuous spectrum, showing clear quantitative
differences between heparin and hyaluronan, but no qualitative differences in
their interaction \enquote{mode}.
