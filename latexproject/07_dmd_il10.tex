...
indicates that the docking solutions obtained for heparin show a little more
spatial consistency in themselves.

The important conclusion to be drawn from this and comparable observations (not
shown) is that the IL-10-GAG system does not easily allow for a quantitative
