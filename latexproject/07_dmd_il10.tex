...
Surprisingly, \textit{all} of the DMD studies performed in the first round of
...
types and lengths investigated in the first round of IL-10-GAG DMD studies (such
...
Further insights were derived from other IL-10-GAG DMD studies. For instance, a
DMD study with a hyaluronan hexasaccharide led to the same qualitative SRED
results, in the sense that R107 stood out. However, the corresponding mean
interaction energy was determined as \SI{-3.8 +- 0.3}{\kilo\calory\per\mol},
i.e.\ about \SI{70}{\percent} less than in case of the heparin hexasaccharide
study discussed in the paragraph above. Again, this is expected as of the
missing sulfate groups in HA compared to HP, and in compliance with the hydrogen
bonding data discussed in the previous section. In general, we can conclude that
...
than hydrogen bonding analysis. Another interesting observation we have made is
...
made in the \enquote{Impact of N-terminal residues and modest geometry changes}
part above.
...
\hl{Note (TODO):}
N=200 and N=300 for much clearer clustering and , reduction of target displacement length
