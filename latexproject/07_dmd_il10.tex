...
\Cref{fig:dmdil10:SRED_hpdp6}

MM-GBSA SRED yields consistent outcome with hydrogen bonding analysis,
whereas hbond analysis is much simpler

include here:

Complete inclusion of IL-10's N terminus does not qualitatively change hbond/SRED data (130530 groupmeeting pdf)


bla bla, note that results in consistency with H-bond.
