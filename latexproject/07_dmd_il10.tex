...
interaction. \Cref{fig:dmdil10:hp_hexa_vs_ha_hexa_hbond} shows ensemble-derived
H-bonding information for two independently performed DMD studies
differing in the GAG type: one was performed with a heparin hexasaccharide, the
other with a hyaluronan hexasaccharide. For each free MD trajectory in these two
DMD studies we determined the normalized occupancy of H-bond donor atoms
in each receptor residue, and ranked the results by the mean normalized
occupancy. We accumulated all donors within single residues, for instance an
arginine can donate up to three hydrogens at the same time, and the maximum
normalized occupancy in this case would be 3.
\Cref{fig:dmdil10:hp_hexa_vs_ha_hexa_hbond} shows the top 6 residues for
both studies, including box plot representations of the corresponding
distributions. In both cases, R107 is ranked first by mean as well as median. In
case of HP dp6, we measured a mean R107 occupancy of 1.5, i.e.\ throughout the
entire DMD study (on average) this residue donated \textit{more than one}
hydrogen atom to H-bonds. This number alone is a strong indicator for the
relevance of this residue in protein-GAG interaction. However, the essential
observation is that R107's hydrogen boding properties qualitatively stand out
compared to all other amino acids: the H-bond occupancy distributions of all
other residues have their maximum near 0, and a slow but constant decay towards
higher occupancies. The occupancy distribution of R107, however, has a clear
maximum at about 1.5. That is, R107 is highly solvent-exposed with most of its
molecular surface, and significantly more accessible for GAG-interaction than
the other residues.

Discuss difference between HA and HP
