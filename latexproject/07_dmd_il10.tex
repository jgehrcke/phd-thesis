...
hydrogen bonding information for two independently performed DMD studies
...
DMD studies we determined the normalized occupancy of hydrogen bond donor atoms
...
\Cref{fig:dmdil10:hp_hexa_vs_ha_hexa_hbond} shows the top 6 of residues for
both studies, including a box plot representation of the corresponding
distributions.

determined those residues
that contributed most hydrogen bonds

integrated and normalized the number of hydrogen bond donors ieach data production period of
