...
Above, we derived that a DMD study is comprised of on the order of $10^3$
computing jobs, and that it requires storing hundreds of gigabytes sof raw data
...
\cite{mercurial_web} in this case). The corresponding code repository is
available at http://bit.ly/jgehrcke-phd-dmd-control.
