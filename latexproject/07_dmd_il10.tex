...
\caption[]{
Merged single-residue energy decomposition (SRED) data for six independently
performedBLa bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla
bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla
bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla
bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla
bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla
bla bla bla bla bla bla bla bla top \SI{40}{\percent} of the DMD runs ranked by
MM-PBSA $\Delta G$ were merged into the data points shown. The error bars
...
In all cases, the docking solutionclustering was performed with $N_{min}$ (the
minimal number of clusters that must be found) set to 1, and $M_{min}$ (the
minimal number of members within each cluster) set to 5.
