...
standard procedure in the Pisabarro research group and has already been used in
a variety of studies \cite{franz_cathepsin_2013,dmd_samsonov_gehrcke_2014} (also
see \cref{dmd:clustering_method} for an application case).
