...
Most monosaccharide rings in GAGs have a clearly predominant conformation, and
can be considered rigid, as is the case for e.g.\ N-acetyl-D-glucosamine (GlcN),
which mainly exists as ${}^{4}\mathrm{C}_1$ chair, which was shown to be
especially stable when the GlcN becomes sulfated
\cite{Sattelle_glcnac_right_chair_2011}, as is the case in heparin.
