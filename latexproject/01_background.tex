...
The biological relevance of the cytokine interleukin-10 (IL-10) has extensively
been reviewed in the work of Moore et al. \cite{moore_2001}). Via its ability to
inhibit effector functions of T cells, monocytes, and macrophages, its critical
...
called a \textit{pleiotropic} cytokine. Overall, IL-10 is a crucial regulator in
immune response, and, as Sabat et al. conclude, knowledge regarding IL-10
effects forces us to think about modulation of IL-10 activity as a potential
therapy.



\subsubsection{IL-10 and its relation to GAGs}

As a regulator of inflammation, IL-10 obviously plays a major role in tissue
repair. Roers et al. found that \cite{roers_il10mice_woundhealing_2007}
...
From \textit{in vitro} experiments, IL-10 is known
