...
As a regulator of inflammation, IL-10 obviously plays a major role in tissue
...
that needs to be maintained in regulating an immune response, even a slight
...
\item the presence of sulfated proteoglycans at the cell surface facilitates the
...
the reduction of sulfated cell-surface proteoglycans was shown shown to reduce
IL-10 function, i.e.\ cell-surface-attached GAGs may \textit{enhance} IL-10
function.
...
\SI{0.5}{\milli\gram\per\milli\liter}. The fact that high molecular weight
GAGs from animal sources were used in the experiments makes it difficult to
assess the effects of GAG length and impurity on the results. Still, even
considering these sources of error, the results published by Salek-Ardakani et
al. are rather convincing, and, as they conclude, these findings support the
hypothesis that soluble and cell-surface GAGs and, in particular, their sulfate
groups are important in modulation of IL-10 activity, and further studies are
required to identify the molecular mechanism for GAG binding to IL-10. Up to
now, several years later, no structural details about IL-10-GAG interaction have
been published, and the deeper biological meaning of IL-10-GAG interaction is
still not clarified. However, it is often speculated that the major role of
cytokine-GAG interaction in general could be the ability of the ECM to affect
the diffusion of such cytokines, and therefore affect their location and local
concentration. In any case, the investigation of the molecular interaction of
IL-10 and GAGs will provide further insights about the relevance and the
