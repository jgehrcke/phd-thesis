...
Free in solution, most monosaccharide rings in GAGs have a clearly predominant
conformation, and their ring structure can therefore largely be considered
...
N-acetyl-D-glucosamine (GlcN) mainly exists in ${}^{4}\mathrm{C}_1$
...
mixture of mainly three conformations: ${}^{4}\mathrm{C}_1$,
...
allows for e.g.\ different orientations of functional groups in space, as
depicted in \cref{fig:bg:idoa_conformations}.
...
in the somewhere within a GAG chain. As shown by Sattelle et al.\, the
population ratio also depends on sulfation, but IdoA2S still prevails in an
equilibrium of multiple highly populated conformations. Regarding
heparin-internal IdoA2S, Muñoz-García and co-workers summarize that it is in
equilibrium of ${}^{2}\mathrm{S}_\mathrm{O}$ and ${}^{1}\mathrm{C}_4$, with a
negligible content of the ${}^{4}\mathrm{C}_1$ chair.
{\cite{conf_idoa_timeavg_restraints_2013}} The interconversion between
${}^{2}\mathrm{S}_\mathrm{O}$ and ${}^{1}\mathrm{C}_4$ on the other hand has
earlier been described to implicate little changes to the geometry of glycosidic
linkages \cite{Mulloy_dyn_conf_heparin_2000}, and the overall polysaccharide
conformation is independent on iduronic acid ring puckering
