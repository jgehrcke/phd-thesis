...
somewhere within a GAG chain. As shown by Sattelle et al.\, the population ratio
also depends on sulfation, and IdoA2S still prevails in an equilibrium of
multiple highly populated conformations. Regarding heparin-internal IdoA2S,
Muñoz-García and co-workers summarize that it is in an equilibrium made of
...
on the other hand has earlier been described to exert only little changes to the
geometry of glycosidic linkages \cite{Mulloy_dyn_conf_heparin_2000}, and the
overall polysaccharide conformation is independent on iduronic acid ring
puckering \cite{jin_heparin_2009}.
