...
\nomenclature{DMD}{Dynamic Molecular Docking}
\nomenclature{tMD}{targeted molecular dynamics}
\nomenclature{LROM}{ligand-reoriented model}
\nomenclature{TDS}{test data set}
\nomenclature{SRED}{single-residue energy decomposition}
\nomenclature{AD3}{AutoDock 3}
