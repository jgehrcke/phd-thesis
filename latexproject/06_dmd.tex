...
a pulling velocity of $s=\SI{30}{\angstrom}$ per $T=4\,\mathrm{ns}$.
...
$T=4\,\mathrm{ns}$. For each point in time during tMD, the structural difference
...
ligand during tMD with $s=\SI{30}{\angstrom}$ and $T=4\,\mathrm{ns}$ in detail, we
...
suggest that with $s=\SI{30}{\angstrom}$ and $T=4\,\mathrm{ns}$ enough translational
...
$(1.0\pm0.4)\,\si{\angstrom}$ (mean value and standard deviation derived from all TDS
...
$(2.3\pm0.6)\,\si{\angstrom}$ (corresponding raw data is shown in
