...
distribution of docking results via clustering (\hl{clustering parameters listed in
Supplementary Table 3, just remove?}). For each complex, we compared the mean structural
