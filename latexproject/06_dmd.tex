...
free MD final system state, i.e.\ from one set of coordinates only. Meaningful
examples of such static quantities are:

\begin{itemize}
\item The minimal distance between receptor an ligand, i.e.\ the distance
...
ligand are in contact or not. An atomic contact usually leads to an inter-atomic
distance of slightly below \SI{2}{\angstrom}.
...
all resulting atom pair distances. For ligand molecules such as GAGst his
